...
# -*- coding: utf-8 -*-
#
# kaybee documentation build configuration file, created by
...
# ones.
extensions = ['sphinx.ext.intersphinx', kaybee.__title__]
...
project = kaybee.__title__
copyright = kaybee.__copyright__
author = kaybee.__author__
...
latex_documents = [
    (master_doc, 'kaybee.tex', 'kaybee Documentation',
     'Paul Everitt', 'manual'),
]
